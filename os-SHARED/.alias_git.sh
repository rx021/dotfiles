...
# git stash show -p 3 
# -- to see the #4 stashed patch/changes

# git show stash@{0} 
# -- to show tracked files stashed in index 0
# git show stash@{0}^3 
# -- to show untracked files stashed in index 0
...
# git log
# -- to see if your current changes match the remote

# -- to see which commits are on your master
#    which you haven't yet pushed
# git log origin/master..master
# alias gld='echo "// git log diff b/w remote"; git log origin/master..master'

# -- to see which commits are on origin/master
