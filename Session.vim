...
exe '5resize ' . ((&lines * 10 + 16) / 33)
exe 'vert 5resize ' . ((&columns * 53 + 79) / 158)
exe '6resize ' . ((&lines * 9 + 16) / 33)
exe 'vert 6resize ' . ((&columns * 53 + 79) / 158)
exe '7resize ' . ((&lines * 9 + 16) / 33)
...
setlocal fdn=20
setlocal nofen
let s:l = 132 - ((0 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 132
...
setlocal fdn=20
setlocal nofen
let s:l = 148 - ((6 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 148
...
setlocal fdn=20
setlocal nofen
let s:l = 260 - ((12 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 260
...
setlocal fdn=20
setlocal nofen
let s:l = 254 - ((0 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 254
