...
badd +264 os-MAC/apps-01-install.sh
...
badd +1 TOOLS/TMUX/tmux-settings.conf
badd +2 TOOLS/TMUX/tmux-bindings.conf
badd +1 TOOLS/TMUX/tmux-status-bar.conf
badd +1 TOOLS/TMUX/tmux-plugins.conf
badd +1 os-LINUX-ubuntu/logs.md
badd +0 os-LINUX-ubuntu/.tmux.conf
argglobal
%argdel
...
wincmd w
argglobal
if bufexists(fnamemodify("os-MAC/apps-01-install.sh", ":p")) | buffer os-MAC/apps-01-install.sh | else | edit os-MAC/apps-01-install.sh | endif
if &buftype ==# 'terminal'
  silent file os-MAC/apps-01-install.sh
endif
...
balt ~/dotfiles/os-LINUX-ubuntu/logs.md
setlocal foldmethod=indent
setlocal foldexpr=0
setlocal foldmarker={{{,}}}
setlocal foldignore=#
...
wincmd w
argglobal
if bufexists(fnamemodify("~/dotfiles/os-LINUX-ubuntu/.tmux.conf", ":p")) | buffer ~/dotfiles/os-LINUX-ubuntu/.tmux.conf | else | edit ~/dotfiles/os-LINUX-ubuntu/.tmux.conf | endif
if &buftype ==# 'terminal'
  silent file ~/dotfiles/os-LINUX-ubuntu/.tmux.conf
endif
setlocal foldmethod=indent
setlocal foldexpr=0
setlocal foldmarker={{{,}}}
...
wincmd w
argglobal
if bufexists(fnamemodify("~/dotfiles/TOOLS/TMUX/tmux-plugins.conf", ":p")) | buffer ~/dotfiles/TOOLS/TMUX/tmux-plugins.conf | else | edit ~/dotfiles/TOOLS/TMUX/tmux-plugins.conf | endif
if &buftype ==# 'terminal'
  silent file ~/dotfiles/TOOLS/TMUX/tmux-plugins.conf
endif
balt ~/dotfiles/TOOLS/TMUX/tmux-bindings.conf
setlocal foldmethod=indent
setlocal foldexpr=0
setlocal foldmarker={{{,}}}
setlocal foldignore=#
