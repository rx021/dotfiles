...
badd +6 SCRIPTS/tmux-new-session.sh
...
badd +376 ~/Downloads/JETPACK/PRJ-RENTATEE-2/api.rentatee.com/tests/Feature/Http/Controllers/External/LeaseDocumentControllerTest.php
argglobal
%argdel
