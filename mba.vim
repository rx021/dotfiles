...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 42 + 71) / 143)
exe 'vert 2resize ' . ((&columns * 41 + 71) / 143)
exe 'vert 3resize ' . ((&columns * 33 + 71) / 143)
exe 'vert 4resize ' . ((&columns * 24 + 71) / 143)
argglobal
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 56 + 71) / 143)
exe 'vert 2resize ' . ((&columns * 48 + 71) / 143)
exe 'vert 3resize ' . ((&columns * 37 + 71) / 143)
argglobal
...
setlocal fdn=20
setlocal nofen
let s:l = 222 - ((6 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 222
...
setlocal fdn=20
setlocal nofen
let s:l = 13 - ((6 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 13
...
exe 'vert 3resize ' . ((&columns * 46 + 71) / 143)
argglobal
balt README.md
setlocal fdm=indent
setlocal fde=0
...
setlocal fdn=20
setlocal nofen
let s:l = 50 - ((0 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 50
...
setlocal fdn=20
setlocal nofen
let s:l = 75 - ((0 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 75
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 50 + 71) / 143)
exe 'vert 2resize ' . ((&columns * 49 + 71) / 143)
...
setlocal fdn=20
setlocal nofen
let s:l = 93 - ((1 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 93
...
setlocal fdn=20
setlocal nofen
let s:l = 538 - ((11 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 538
